        ...
        public static void CheckOutPage()
        {
            ...
            if (filteredUsers.Count > 0) {
                while (true)
                {
                    ...
                    Console.WriteLine("\n---------- SELECT USER FOR CHECK OUT REPORT  ----------\n");
                    ...
                    try
                    {
                        ...
                        Room userRoom = new Room(toUpdatedRoom.No, toUpdatedRoom.RoomCount, toUpdatedRoom.WindowCount, toUpdatedRoom.hasLandscape) { LastCheckIn = toUpdatedRoom.LastCheckIn, LastCheckOut = DateTime.Now };
                        ...
                        Console.WriteLine($"\n{selectedUser.Name} {selectedUser.Surname}'s Check Out Saved to database\n");
                        Thread.Sleep(2000);
                        Pages.ModesPage();
                    }
                    catch (Exception ex)
